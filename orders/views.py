...
def payments(request):
    ...
    # Send Order recieved email customer
    ...
    # Send Order number and transaction id back to sendData method vua JsonResponse    
    data    = {
...
def place_order(request, total=0, quantity=0,):
    ...
    # if the cart count is less than or equal to 0 then redirect back to shop store
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date        = d.strftime("%Y%m%d") #20231008
